...
class QuantityOfferTier(Base):
    ...
    label_top_position: Mapped[str] = mapped_column(String(10), default="left")
    label_inner_text: Mapped[str | None] = mapped_column(String(100))
    label_inner_bg_color: Mapped[str] = mapped_column(String(50), default="#6B7280")
    label_inner_text_color: Mapped[str] = mapped_column(String(50), default="#FFFFFF")
